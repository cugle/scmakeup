...
var SF_MESS_FORM_NAME			= "feedback";
...
var SF_MESS_POST_ACTION         = "/index.php?m=formguide&c=index&a=show&formid=11&siteid=1";
...
'<form style="margin:0;"  name="${SF_MESS_FORM_NAME}" method="post" action="${SF_MESS_POST_ACTION}" enctype="multipart/form-data">',
'<input name="enews" type="hidden" value="AddFeedback"><input type="hidden" name="bid" id="bid"  value="2"><input type=hidden name=ecmsfrom value="/">',
	...
	'<div id="${SF_MESS_BODY_ID}">',
		...
		'<div id="${SF_MESS_BODY_BOTTOM_ID}">',
			'<input id="${SF_MESS_SUBMIT_ID}" type="button" name="button" onclick="${SF_MESS_FRAME_ID}.submit()"  value="${sf_mess_cfg.send}">',

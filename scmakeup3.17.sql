...
(1, 'admin', '70c4709f019dfafe0073830904e4c13e', 1, 'sMvrsa', '127.0.0.1', 1395037498, 'admin@admin.com', '', '', '');
...
(15, 33, 0, '创业加盟好项目，sc美妆连锁加盟', '', 'http://www.scmakeup.com/uploadfile/2014/0306/20140306043830413.jpg', '', '', 0, 'http://www.scmakeup.com/html/2014/mediareport_0306/15.html', 0, 99, 1, 0, 'admin', 1394095100, 1394096564);
...
('v27rvv3fla33bq5b3hvr8cbah4', 1, '127.0.0.1', 1395049460, 1, 0, 'admin', 'index', 'public_session_life', 'code|s:4:"ctmn";userid|s:1:"1";roleid|s:1:"1";pc_hash|s:6:"OAnDS0";lock_screen|i:0;');
...
--
-- 转存表中的数据 `sc_sso_session`
--

INSERT INTO `sc_sso_session` (`sessionid`, `userid`, `ip`, `lastvisit`, `roleid`, `groupid`, `m`, `c`, `a`, `data`) VALUES
('v27rvv3fla33bq5b3hvr8cbah4', 0, 'ip', 1395047033, 0, 0, 'admin', 'login', 'a', 'code|s:4:"avd9";');
